...
PROTOBUF_NAMESPACE_OPEN
template<> ::lspb::CliReq* Arena::CreateMaybeMessage<::lspb::CliReq>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace lspb {
...
class CliReq PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lspb.CliReq) */ {
 public:
...
inline const ::lspb::CliEnterRoom& CliReq::_internal_clienterroom() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::lspb::CliEnterRoom*>(
...
inline const ::lspb::CliInitOver& CliReq::_internal_cliinitover() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::lspb::CliInitOver*>(
...
inline const ::lspb::CliOperate& CliReq::_internal_clioperate() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::lspb::CliOperate*>(
...
template <> struct is_proto_enum< ::lspb::ClientMsgType> : ::std::true_type {};
template <>

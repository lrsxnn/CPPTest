...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gameProto_2eproto = {
  false, false, descriptor_table_protodef_gameProto_2eproto, "gameProto.proto", 431,
  &descriptor_table_gameProto_2eproto_once, descriptor_table_gameProto_2eproto_sccs, descriptor_table_gameProto_2eproto_deps, 9, 0,
  schemas, file_default_instances, TableStruct_gameProto_2eproto::offsets,
  file_level_metadata_gameProto_2eproto, 9, file_level_enum_descriptors_gameProto_2eproto, file_level_service_descriptors_gameProto_2eproto,
};
...
::PROTOBUF_NAMESPACE_ID::uint8* BGameInit::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_plist_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
...
void PlayerInfo::InternalSwap(PlayerInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PlayerInfo, startpoint_)
      + sizeof(PlayerInfo::startpoint_)
...
::PROTOBUF_NAMESPACE_ID::uint8* BGameFrame::_InternalSerialize(
  ...
  // repeated .lspb.CliOperate operList = 2;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_operlist_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
CliOperate::CliOperate(const CliOperate& from)
  ...
  ::memcpy(&isfire_, &from.isfire_,
    ...
    reinterpret_cast<char*>(&isfire_)) + sizeof(playerid_));
...
void CliOperate::SharedCtor() {
  ...
  direction_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&isfire_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&playerid_) -
      reinterpret_cast<char*>(&isfire_)) + sizeof(playerid_));
}
...
void CliOperate::InternalSwap(CliOperate* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CliOperate, playerid_)
      + sizeof(CliOperate::playerid_)
      - PROTOBUF_FIELD_OFFSET(CliOperate, isfire_)>(
...
template<> PROTOBUF_NOINLINE ::lspb::CliEnterRoom* Arena::CreateMaybeMessage< ::lspb::CliEnterRoom >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::CliEnterRoom >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::SrvEnterRoom* Arena::CreateMaybeMessage< ::lspb::SrvEnterRoom >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::SrvEnterRoom >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::BGameInit* Arena::CreateMaybeMessage< ::lspb::BGameInit >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::BGameInit >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::PlayerInfo* Arena::CreateMaybeMessage< ::lspb::PlayerInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::PlayerInfo >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::CliInitOver* Arena::CreateMaybeMessage< ::lspb::CliInitOver >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::CliInitOver >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::SrvInitOver* Arena::CreateMaybeMessage< ::lspb::SrvInitOver >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::SrvInitOver >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::BGameStart* Arena::CreateMaybeMessage< ::lspb::BGameStart >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::BGameStart >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::BGameFrame* Arena::CreateMaybeMessage< ::lspb::BGameFrame >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lspb::BGameFrame >(arena);
}
template<> PROTOBUF_NOINLINE ::lspb::CliOperate* Arena::CreateMaybeMessage< ::lspb::CliOperate >(Arena* arena) {
